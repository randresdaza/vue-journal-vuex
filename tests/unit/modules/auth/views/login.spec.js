...
describe('Pruebas en el Login Component', () => {
    ...
    test('Credenciales incorrectas, disparan Sweet Alert', async () => {
    ...
    test('Debe redirigir a la ruta: no-entry', async () => {
        ...
        await txtEmail.setValue('andres@gmail.com')
        await txtPassword.setValue('123456')

        await wrapper.find('form').trigger('submit')

        expect(store.dispatch).toHaveBeenCalledWith('auth/signInUser', { 'email': 'andres@gmail.com', 'password': '123456' })
